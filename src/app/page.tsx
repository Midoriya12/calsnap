...
export default function CalSnapPage() {
  ...
  if (!user) { // This case should ideally be caught by the useEffect redirect, but as a safeguard
    return (
       <div className="flex flex-col flex-grow">
        <AppHeader />
        <div className="flex-grow flex items-center justify-center">
  ...
  // If user is logged in, show the main page content regardless of email verification
  return (
